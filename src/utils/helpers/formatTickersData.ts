...
const formatTickersData = (data: Object[]): StockData[] => data.map((ticker: {
  ...
  const priceForClosed = ticker.day.c || ticker.prevDay.c || ticker.lastTrade.p || ticker.lastQuote.P || ticker.min.o;
  const priceForOpen = ticker.day.c || ticker.lastTrade.p || ticker.prevDay.c || ticker.lastQuote.P || ticker.min.o;
